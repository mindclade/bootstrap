...
This repository defines Mindclade's Ring-0 bootstrap authority: protected state backends, root audit retention, human and workload federation, non-exportable signing roots, time-limited break-glass access, and independently encrypted recovery exports. The authoritative path manifest is `docs/architecture/repository-path-manifest.yaml` in the protected Mindclade monorepo; this repository deliberately carries no duplicate Blueprint authority.
